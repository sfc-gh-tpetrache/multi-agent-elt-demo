...
-- ============================================================================
-- USE DATABASE FROSTBYTE_AI_DEV (or PROD); USE WAREHOUSE WH_AGENT.
-- NOTE: The MCP server is retained for external client access (Cursor, Claude
-- Desktop, etc.) but the ELT_ROUTER uses direct cortex_agent_run tools instead.
-- ============================================================================
  ...
  FROM SPECIFICATION $$
  {
    ...
    "tool_resources": {
      "marketing-campaign-roi": {
        ...
        "semantic_view": "FROSTBYTE_AI_DEV.SEMANTIC.SV_MKT_CAMPAIGN_ROI"
      }
    }
  }
  $$;
...
CREATE OR REPLACE MCP SERVER MARKETING_AGENT_SERVER
  ...
  tools:
    - title: "Delegate to Marketing sub-agent"
      ...
      identifier: "FROSTBYTE_AI_DEV.AGENTS.MARKETING_AGENT"
